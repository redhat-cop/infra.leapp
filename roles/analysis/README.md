...
| leapp_secure_logging                        | Boolean           | true                        | When `true`, tasks that handle sensitive data (such as Satellite credentials) have logging suppressed. Set to `false` to allow logging of these tasks for debugging. |
